...
<div class="container-fluid">
   <div class="row align-items-center pt-2">
      ...
      <div class="col-lg-6 col-sm-6 text-center">
         <h1 class="font-36 fw-bold text-uppercase text-purple">MY TALENT VIDEOS
      ...
      <div class="col-12 pb-4">
         <div class="row align-items-start">
            <div class="col-lg-3 col-sm-4">
               <p>
                  <a href="" class="font-16 text-white  py-2 px-3 bg-success fw-500 align-items-center  rounded-pill"  data-bs-toggle="modal" data-bs-target="#uploadCertificate"><i class="fa-solid fa-upload"></i>  Upload Video</a>
               </p>
            </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="mb-3">
                <label for="formFileMultiple" class="form-label font-20  fw-bolder text-purple">Multiple Video  files  </label>
